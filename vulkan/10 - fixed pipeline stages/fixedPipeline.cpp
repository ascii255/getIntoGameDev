...
/*------------------- variables ----------------------*/
	...
	//an image view describes how to view/access an image
	...
	void createGraphicsPipeline() {
		...
		vertexInputInfo.vertexBindingDescriptionCount = 0; //eg. layout of data in memory, spacing etc
		vertexInputInfo.pVertexBindingDescriptions = nullptr;
		vertexInputInfo.vertexAttributeDescriptionCount = 0; //hard-coded positions and colors
