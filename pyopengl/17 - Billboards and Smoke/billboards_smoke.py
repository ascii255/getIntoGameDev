...
def initialise_opengl():
    ...
    return (shader3DTextured, shader3DColored, shader2DTextured, shader2DColored, shader2DText, shader2DParticle, shader3DBillboard)
...
class GameApp:
    ...
    def mainLoop(self):
        ...
        self.light.update()
        self.light2.update()
        self.player.update([self.shader3DColored, self.shader3DTextured, self.shader3DBillboard])
