...
def initialise_opengl():
    ...
    return (shader3DTextured, shader3DColored, shader2DTextured, shader2DColored, shader2DText, shader2DParticle, shader3DBillboard, shader3DCubemap)
...
class GameApp:
    ...
    def create_objects(self):
        ...
        self.smokeTexture = SimpleMaterial("gfx/smoke")
        self.smoke = BillBoard(1,1,self.smokeTexture, self.shader3DBillboard)
        ground_model = ObjModel("models", "ground.obj", self.shader3DTextured, self.wood_texture)
...
class MenuApp:
    ...
    def create_objects(self):
        ...
        createInfo = ParticleEmitter2DCreateInfo()
