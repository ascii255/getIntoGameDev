...
def create_framebuffer():
    ...
    multisampleColorBuffer = glGenTextures(1)
    ...
    singlesampleColorBuffer = glGenTextures(1)
    glBindTexture(GL_TEXTURE_2D, singlesampleColorBuffer)
    ...
    glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, 
                                GL_TEXTURE_2D, singlesampleColorBuffer, 0)

    glBindFramebuffer(GL_FRAMEBUFFER, 0)

    return (multisampleFBO, multisampleColorBuffer, MultisampleDepthStencilBuffer, singlesampleFBO, singlesampleColorBuffer)

def teardown_program_environment(shaders, framebuffer):

    (multisampleFBO, multisampleColorBuffer, MultisampleDepthStencilBuffer, singlesampleFBO, singlesampleColorBuffer) = framebuffer
    glDeleteFramebuffers(1,(multisampleFBO,))
    glDeleteTextures(1,(multisampleColorBuffer,))
    glDeleteRenderbuffers(1, (MultisampleDepthStencilBuffer,))
    glDeleteFramebuffers(1,(singlesampleFBO,))
    glDeleteTextures(1,(singlesampleColorBuffer,))
...
class GameApp:
    def __init__(self):
        ...
        self.multisampleColorBuffer = framebuffer[1]
        self.MultisampleDepthStencilBuffer = framebuffer[2]
        self.singlesampleFBO = framebuffer[3]
        self.singlesampleColorBuffer = framebuffer[4]
    ...
    def create_objects(self):
        ...
        self.lightCount += 1
        self.screen = TexturedQuad(0, 0, 2, 2, self.singlesampleColorBuffer, self.shader2DTextured)
